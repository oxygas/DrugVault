  ...
  return (
    <div className="glass rounded-xl p-4 lg:p-5 border border-[var(--border)]">
      <div className="flex items-center justify-between gap-2 mb-3.5">
        <span className="text-[10px] lg:text-[11px] font-mono font-bold uppercase tracking-wider px-2.5 py-1 lg:px-3 lg:py-1.5 rounded-full bg-[rgba(var(--accent-rgb),0.08)] text-[var(--accent2)] border border-[rgba(var(--accent-rgb),0.12)]">
          {roa.n}
        </span>
        <span

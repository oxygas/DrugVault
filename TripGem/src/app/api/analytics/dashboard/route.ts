  ...
  try {
    ...
    return Response.json({
      ...
      substanceStats: {
        ...
        highHarmCount: stats.highHarmCount,
        highAddictionCount: stats.highAddictionCount,
        highOdRiskCount: stats.highOdRiskCount,
        totalCombos: stats.totalCombos,
        dangerousCombos: stats.dangerousCombos,
        safeCombos: stats.safeCombos,

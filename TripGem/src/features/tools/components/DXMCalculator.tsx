             ...
             <div className="space-y-2">
               <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 min-w-0 px-4 py-3 rounded-xl text-base text-white placeholder:text-[var(--text4)] bg-[rgba(10,10,30,0.5)] border border-[var(--border2)] focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all"
                />
                <div className="flex rounded-xl overflow-hidden border border-[var(--border2)] bg-[rgba(10,10,30,0.5)]">
                  <button
                    onClick={() => setWeightUnit('kg')}
                    className={`px-4 py-3 text-sm font-mono font-bold tracking-wider transition-all min-w-[50px] ${
               ...
               <div className="min-h-[16px] pl-1">
                 ...
                 {loading && (
                   <span className="text-[11px] font-mono text-[var(--text4)] animate-pulse">
                     Detecting...
                   </span>
                 )}
               </div>

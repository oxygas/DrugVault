...
export default function HomeClient({ substances, stats, categories, comboMatrix, substanceCombos }: HomeClientProps) {
  ...
  const sortedSubstances = useMemo(() => {
    return [...substances].sort((a, b) => {
      if ('popularityRank' in a && 'popularityRank' in b) {
        return (a.popularityRank as number) - (b.popularityRank as number);
      }
      ...
      >
        <div className="w-full px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExYXFkdHQzaHphODF6Y3Rlb2JnMTYybzlsaHVibG8zZXNpYjAybWc4NCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/Wt0zLr2PkDbDkfQOSo/giphy.gif" alt="TripGem" className="w-7 h-7 rounded" />

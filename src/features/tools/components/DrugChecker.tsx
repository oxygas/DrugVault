    ...
    <div className="w-full space-y-6 sm:space-y-10 lg:space-y-14">
      ...
      <div ref={searchRef} className="space-y-4 sm:space-y-8">
        <div className="relative">
          <div className="flex items-center gap-3 sm:gap-5 bg-[var(--bg3)] border-2 border-[var(--border2)] rounded-xl sm:rounded-2xl px-4 sm:px-8 py-4 sm:py-6 focus-within:border-purple-500/50 focus-within:ring-2 focus-within:ring-purple-500/20 transition-all">

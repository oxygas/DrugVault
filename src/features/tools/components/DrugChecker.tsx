    ...
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div ref={searchRef} className="mb-6">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus-within:border-purple-500/50 focus-within:ring-2 focus-within:ring-purple-500/20 transition-all">
          ...
          {dropdownOpen && filtered.length > 0 && (
            <div className="absolute z-20 w-full mt-2 bg-gray-900 border border-white/10 rounded-xl shadow-xl max-h-64 overflow-y-auto">
              {filtered.map((s, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-white font-medium flex-1 text-left">{s.name}</span>
        ...
        <button
          ...
          className={`px-6 py-3 rounded-xl font-semibold text-white transition-all flex items-center gap-2 ${
            canCheck
              ...
              : 'bg-gray-700 cursor-not-opacity-50'
          }`}
        >
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider">Overall Risk</h3>
              <span
          ...
          {/* Interaction Pairs */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">All Interactions</h3>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 flex-1">
                        <span className="w-2 h-2 rounded-full" style={{ background: CATEGORY_COLORS[pair.a.category] }} />
                        <span className="text-white font-medium">{pair.a.name}</span>
                        <span className="text-gray-500">+</span>
                        <span className="w-2 h-2 rounded-full" style={{ background: CATEGORY_COLORS[pair.b.category] }} />
                        <span className="text-white font-medium">{pair.b.name}</span>
                        <span
      ...
      {!results && selected.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 mb-1">No substances selected</p>
          <p className="text-sm text-gray-500">Search and add substances to check for interactions</p>
        </div>
      )}
    </div>
  )
